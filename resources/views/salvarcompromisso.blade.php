                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading"></div>
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" role="form" method="POST" action="{{ route('cadcompromisso') }}">
                                                        {{ csrf_field() }}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="assunto" type="text" class="form-control{{ $errors->has('assunto') ? ' is-invalid' : '' }}" name="assunto" value="{{ old('assunto') }}" required >
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="data" type="text" class="form-control{{ $errors->has('data') ? ' is-invalid' : '' }} date form-control" name="data" value="{{ old('data') }}" required >
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="hora" type="time" class="form-control{{ $errors->has('hora') ? ' is-invalid' : '' }}" name="hora" value="15:30" required >
